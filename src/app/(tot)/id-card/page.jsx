          ...
          <div className="space-y-4 max-w-sm text-xs text-slate-300">
            ...
            <div className="pt-2">
              <button
                ...
                className="w-full py-3 rounded-xl bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-slate-950 font-black text-xs flex items-center justify-center gap-2 shadow-lg shadow-amber-500/20 transition-all"
              >
